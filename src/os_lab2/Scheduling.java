...
import java.io.*;
import java.util.*;
import os_lab2.sProcess;
import os_lab2.Common;
import os_lab2.Results;
import os_lab2.SchedulingAlgorithm;
        ...
        try {
            ...
            while ((line = in.readLine()) != null) {
                ...
                if (line.startsWith("process")) {
                    ...
                    processVector.addElement(new sProcess(cputime, ioblocking, 0, 0, 0,0,-1));
                }
